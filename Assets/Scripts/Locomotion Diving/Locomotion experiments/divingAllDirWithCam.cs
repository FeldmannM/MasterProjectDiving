...
public class divingAllDirWithCam : MonoBehaviour
{
    [SerializeField]
    ...
    void FixedUpdate()
    {
        // Idee Tauchen in alle Richtungen mit der Möglichkeit sich auf der Stelle zu drehen, basierend auf der Kamera Richtung
        if (leftConPos != null && rightConPos != null)
        {
